...
batch_size=16
seed=2024
experiment_tag="wavelet_db4"  # 实验标签，用于区分不同实验
wavelet="db4"
use_cross_attention="--use_cross_attention"  # 如果使用交叉注意力，保留此参数；否则删除
...
nohup python train_wavelet.py \
    ...
    $use_cross_attention \
    --seed $seed \
    --embed_version wavelet \
    --save ./logs_wavelet/ > "$log_file" 2>&1 &
